package com.tata.bookService.aspect;
...
public class LoggingAspect {
	...
	@After("execution(* com.tata.bookService.*.*.*(..)) ")
	...
	@AfterThrowing(pointcut = "execution(* com.tata.bookService.*.*.*(..))", throwing = "ex")
	...
	@AfterReturning(pointcut = "execution(* com.tata.bookService.*.*.*(..))", returning = "returnValue")
